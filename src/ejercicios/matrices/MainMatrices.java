...
public class MainMatrices {
	...
	public static void main(String[] args) {
		...
		//4. Declarar una matriz miMatriz1 de tipo long con 1 filas y 2 columnas
		// y asignar a la posición [0][0] el valor de 2, posición [1][1] el valor de 8
		// posición [2][2] el valor de 2
